...
let upload_items = () => {
    let x = '<img src="https://i3.stat01.com/1/5230/52292448/afacdb/sistema-proezda-po-zvonku-s-telefona.jpg" style="margin: 5px; width: 35%; border-radius: 5px;">';
    ...
    for (let i = 0; i < namelist2.length; i++) {
        ...
        item += '<img src="https://i3.stat01.com/1/5230/52292448/afacdb/sistema-proezda-po-zvonku-s-telefona.jpg" style="margin: 5px; width: 41%; border-radius: 5px;"></img>';
